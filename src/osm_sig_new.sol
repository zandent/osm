...
contract OSM is LibNote {
    ...
    signal PriceFeedUpdate(bytes32);
    handler SendUpdate(bytes32);
    ...
    constructor(address src_) public {
        wards[msg.sender] = 1;
        src = src_;
        //signal and handler are initlized
        PriceFeedUpdate.create_signal();
        SendUpdate.create_handler("Update(bytes32)", 1000000, 120),;
        ...
        SendUpdate.bind(this_address, "PriceFeedUpdate(bytes32)");
    }
